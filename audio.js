...
const GameAudio=(()=>{
 const files={glass:'sfx/glass.mp3',can:'sfx/can-open.mp3',steps:'sfx/footsteps.mp3',steam:'sfx/steam.mp3',music:'music/arkady-hunting.mp3',monsterLarge:'sfx/monster-large.mp3',monsterSmall:'sfx/monster-small.mp3',monsterCan:'sfx/monster-can.mp3'};
 const lines=[
 ...
 const live=new Set();let level=0,monsterAt=-10;
 ...
 function reset(){pause();musicOffset=0;nextVoice=0;walkTime=0;nextWalk=13;monsterAt=-10;lastLine={};foamAt=-1;stepAt=-1;}
 ...
 return{resume,pause,reset,setLevel,monster,setEnabled,setVolume,get volumes(){return {...levels};},say,shot,impact,update,hit,kill,lines,get enabled(){return enabled;},get loaded(){return Object.keys(buffers);}};
})();
